...
<head>
    ...
    <title><?php echo __('miracles_title'); ?></title>
...
<body>
    ...
    <header class="topbar">
        ...
        <ul class="topbar-menu">
            ...
            <li>
                <a href="miracles.php" class="active">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main class="layout">
        <section class="panel">
            <div class="section-heading">
                <div>
                    <h2><?php echo __('miracles_heading'); ?></h2>
                    <p><?php echo __('miracles_subheading'); ?></p>
                </div>
            </div>
            ...
            <form method="GET" class="search-row">
                <div class="search-wrapper">
                    <input type="text" name="search" placeholder="<?php echo __('search_miracles_placeholder'); ?>" value="<?php echo htmlspecialchars($search_query); ?>">
            ...
            <div class="miracles-grid">
                        ...
                        <div class="miracle-card">
                            <div class="miracle-header">
                                ...
                                <span class="miracle-ref-badge">
                                    <?php echo __('surah_label'); ?> <?php echo htmlspecialchars($m['surah_name'] ?? $m['surah_number']); ?> | <?php echo __('verse_label'); ?> <?php echo $m['ayah_number']; ?>
                                </span>
                            </div>
                            ...
                            <div class="miracle-verse-box">
                                <?php if ($m['text_uthmani']): ?>
                                    ...
                                    <span class="miracle-verse-meta">
                                        [<?php echo __('surah_label'); ?> <?php echo htmlspecialchars($m['surah_name']); ?>, <?php echo __('verse_label'); ?> <?php echo $m['ayah_number']; ?>]
                                    </span>
                                <?php else: ?>
                                    <div class="miracle-verse-text" style="font-size: 16px; color: var(--text-muted);">
                                        <?php echo __('download_quran_prompt'); ?>
                                    </div>
                                    <span class="miracle-verse-meta">
                                        [<?php echo __('surah_label'); ?>: <?php echo $m['surah_number']; ?>, <?php echo __('verse_label'); ?>: <?php echo $m['ayah_number']; ?>]
                                    </span>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="miracle-details-grid">
                                <div class="details-col">
                                    <h4>
                                        ...
                                        <?php echo __('quran_meaning_context'); ?>
                                    </h4>
                                ...
                                <div class="details-col">
                                    <h4>
                                        ...
                                        <?php echo __('modern_scientific_verification'); ?>
                                    </h4>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <h3><?php echo __('no_miracles_found'); ?></h3>
                        <p><?php echo __('no_miracles_desc'); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </section>
