<?php
// بوابة الحماية الأمنية للتحقق من الجلسة (Session)
require_once 'auth_check.php';
// استدعاء ملف الاتصال بقاعدة البيانات
require_once 'koneksi.php';

// جلب إحصائيات مواضيع الإعجاز العلمي من قاعدة البيانات
$miracles_count = 0;
...
// جلب عدد الآيات القرآنية المدخلة في قاعدة البيانات
$verses_count = 0;
...
<head>
    ...
    <title>Dashboard | Quran Analytics</title>
    <!-- Google Fonts: Inter -->
    ...
    <main class="layout">
        <section class="panel">
            <div class="section-heading">
                <h2>Dashboard Analytics & Quran Data</h2>
                <p>Welcome back! Monitor database statistics and explore integrated scientific miracles in the Holy Quran.</p>
            </div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3>Scientific Pointers</h3>
                        <p><?php echo $miracles_count; ?> Topics</p>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <h3>Imported Verses</h3>
                        <p><?php echo number_format($verses_count); ?> Verses</p>
                    </div>
                </div>
            ...
            <div class="features-grid">
                ...
                <div class="feature-card">
                    <h3>Scientific Miracles Directory</h3>
                    <p>Explore scientific statements in the Holy Quran, linking divine words directly with modern discoveries in geology, astronomy, and oceanography.</p>
        ...
        <!-- Sidebar / Meta Details LTR -->
        <aside class="sidebar-card">
            <div class="sidebar-box">
                <h3>About Project</h3>
                <p style="font-size: 13.5px; color: var(--text-muted); line-height: 1.7;">
                    A modern educational web platform linking Quranic studies with scientific realities. Developed in PHP and integrated with MySQL/MariaDB using XAMPP for high performance and security.
                </p>
            </div>
            ...
            <div class="sidebar-box">
                ...
                <ul>
                    <li>
                        ...
                        <span>Protected Session Gateways</span>
                    </li>
                    <li>
                        <svg fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span>Prepared SQL Statements</span>
                    </li>
                    <li>
                        <svg fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        <span>Sanitized Form Inputs</span>
                    </li>
                </ul>
            </div>
        </aside>
