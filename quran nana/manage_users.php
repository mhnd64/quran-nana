...
// 1. Strict access control (only administrators)
...
$users_res = mysqli_query($conn, "SELECT id, username, role, created_at FROM `user` ORDER BY id DESC");
$users = [];
    ...
    <main class="layout">
        ...
        <section class="panel">
            <div class="section-heading">
                <h2>Add New User</h2>
                <p>Register a new system user with standard student or administrative privileges.</p>
            </div>
        ...
        <section class="panel">
            <div class="section-heading">
                ...
                <p>Browse through registered users, monitor roles, and delete accounts.</p>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-links">
                                            ...
                                            <?php else: ?>
                                                <a href="manage_users.php?delete=<?php echo $u['id']; ?>" class="action-link-delete">Delete</a>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                </tr>
